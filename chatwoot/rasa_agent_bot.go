...
import (
	...
	"github.com/Kai-Karren/agent-bot-gateway/rasa"
	...
	if rasaResponse.HasCustom() {
		...
		if ok {
			...
			if value == true {
				...
				agentBot.ChatwootClient.CreateOutgoingMessage(conversationId, "Sie haben das Ende Ihrer Interaction mit dem System im Rahmen dieser Studie erreicht. Bitte füllen Sie nun den Fragebogen aus.")
